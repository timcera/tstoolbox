...
def convert_index(
    ...
    epoch : str
        ...
        +------------+----------------------+------------------+---------------+
        | lilian     | 1582-10-15           | floor (JD -      | Count of days |
        |            |                      | 2299159.5)       | of the        |
        |            |                      |                  | Gregorian     |
        |            |                      |                  | calendar,     |
        |            |                      |                  | integer       |
        +------------+----------------------+------------------+---------------+
        | rata_die   | 0001-01-01 proleptic | floor (JD -      | Count of days |
        |            | Gregorian calendar   | 1721424.5)       | of the Common |
        |            |                      |                  | Era, integer  |
        +------------+----------------------+------------------+---------------+
        | mars_sol   | 1873-12-29:12        | (JD - 2405522)   | Count of      |
        |            |                      | /1.02749         | Martian days  |
        +------------+----------------------+------------------+---------------+
        | unix       | 1970-01-01T00:00:00  | JD - 2440587.5   | seconds       |
        +------------+----------------------+------------------+---------------+
