...
class TestFill(TestCase):
    def setUp(self):
        ...
        self.ffill_compare_cli = capture.capture(tsutils.printiso,
                                                 self.ffill_compare)
        ...
        self.bfill_compare_cli = capture.capture(tsutils.printiso,
                                                 self.bfill_compare)
        ...
        self.linear_compare_cli = capture.capture(tsutils.printiso,
                                                  self.linear_compare)
        ...
        self.nearest_compare_cli = capture.capture(tsutils.printiso,
        ...
        self.mean_compare_cli = capture.capture(tsutils.printiso,
                                                self.mean_compare)
        ...
        self.median_compare_cli = capture.capture(tsutils.printiso,
                                                  self.median_compare)
        ...
        self.max_compare_cli = capture.capture(tsutils.printiso,
                                               self.max_compare)
        ...
        self.min_compare_cli = capture.capture(tsutils.printiso,
                                               self.min_compare)
        ...
        self.con_compare_cli = capture.capture(tsutils.printiso,
                                               self.con_compare)
