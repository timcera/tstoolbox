...
class TestFill(TestCase):
    ...
    def test_fill_bfill_cli(self):
        args = 'tstoolbox fill --method="bfill" --input_ts=tests/test_fill_01.csv'
        args = shlex.split(args)
        out = subprocess.Popen(args, stdout=subprocess.PIPE, stdin=subprocess.PIPE).communicate(input=self.ats_cli)[0]
        self.maxDiff = None
    ...
    def test_fill_linear_cli(self):
        args = 'tstoolbox fill --method="linear" --input_ts=tests/test_fill_01.csv'
        args = shlex.split(args)
        out = subprocess.Popen(args, stdout=subprocess.PIPE, stdin=subprocess.PIPE).communicate(input=self.ats_cli)[0]
        self.maxDiff = None
    ...
    def test_fill_nearest_cli(self):
        args = 'tstoolbox fill --method="nearest" --input_ts=tests/test_fill_01.csv'
        args = shlex.split(args)
        out = subprocess.Popen(args, stdout=subprocess.PIPE, stdin=subprocess.PIPE).communicate(input=self.ats_cli)[0]
        self.maxDiff = None
    ...
    def test_fill_mean_cli(self):
        args = 'tstoolbox fill --method="mean" --input_ts=tests/test_fill_01.csv'
        args = shlex.split(args)
        out = subprocess.Popen(args, stdout=subprocess.PIPE, stdin=subprocess.PIPE).communicate(input=self.ats_cli)[0]
        self.maxDiff = None
